...
app.delete('/delete/:id',async(req,res)=>{
    ...
    deletedTodo ? res.status(200).json({msg: "Success", date: deletedTodo}):res.status(500).json({msg: "Error", data: deletedTodo})
})
...
app.put('/update/:id', async(req, res)=>{
    ...
    todo ? res.status(200).json({msg: "Success", date: todo}):res.status(500).json({msg: "Error", data: todo})
})
...
app.post('/user/create', async(req, res)=>{
    ...
    newUser ? res.status(201).json({msg: "Success", data: newUser}) : res.status(500).json({msg: "Error", data: newUser})
